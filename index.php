...
<body style="background: linear-gradient(#084298,#f8f9fa);">
    ...
    <nav class="navbar navbar-expand-lg navbar-white bg-white fixed fixed-top" style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px white;">
        <div class="container-fluid">
            <a href="home.php"><img src="bitcoin.png" alt="" style="height: 50px; margin-left:25px; margin-top:10px;"></a>
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link active text-nowrap" aria-current="page" href="#">Home</a>
                    </li>
    ...
    <div class="container-large" style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:transparent;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont" style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to the<br> Sparks
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="home.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container" style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
            <h1 style="text-shadow:2px 2px 2px gray; color:blue;"><b>Our Amazing Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div style="background-color:#d3e5e7; color:#213242; width: 90%; border-radius:30px; box-shadow:3px 3px 8px black; padding:20px 10px 20px 10px;">
                            ...
                            <h6> A Bank's Customer list can be found here.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div style="background-color:#d3e5e7; color:#213242; width: 90%; border-radius:30px; box-shadow:3px 3px 8px black; padding:20px 10px 20px 10px;">
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6> you can send money from your account here.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div style="background-color:#d3e5e7; color:#213242; width: 90%; border-radius:30px; box-shadow:3px 3px 8px black; padding:20px 10px 20px 10px;">
