...
<body style="background: linear-gradient(#f8f9fa,#084298);">
    ...
    <nav class="navbar navbar-expand-lg navbar-white bg-white fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="home.php"><img src="bitcoin.png" alt=""
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="profile.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Mayur Patel</h1>
            <p style="color:black;"><b>Intern at Sparks Foundation <br> Gujarat technological university , Gujarat</b></p>
    </center>
